...
@section('content')
{{-- <div class="contact-section bg-white position-fixed h-100 m-6"> --}}
            ...
            <div class="card">
                ...
                <form class="card_form">
                    <div class="form-group">
                        <input class="form-field" type="text" placeholder="Enter Course Nane" name="subject">
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-field" type="tel" placeholder="+977-0000000000" name="phone">
                    </div>

                    <div class="form-group">
                        <input class="form-field" type="email" placeholder="name@gmail.com" name="email">
                    </div>

                    <div class="form-group">
                        <textarea class="form-field" type="tel" placeholder=" Message..." rows="2"
                                  name="subject"></textarea>
                    </div>

                    <div class="button-group d-flex justify-center">
                        <a href="#" class="boton">
